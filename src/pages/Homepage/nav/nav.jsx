        ...
        <div className="nav container ">
            ...
            <div className={`list ${Showlis}`}>
                <ul>
                    ...
                    <li>
                        <p>لوح التحمم </p>
                        <img src={Homefig} alt="" /></li>
                    <li>
                        <p>الموظفين</p>
                        <img src={Empolyees} alt="" /></li>
                    <li>
                        <p>المرضى</p>
                        <img src={patient} alt="" /></li>
                    <li>
                        <p>الفواتير </p>
                        <img src={Invoice} alt="" /></li>
                    <li> 
                        
                        <p>الطبيب</p>
                        <img src={Doctor} alt="" /></li>
                    <li>
                        
                        <p>صيدلاني</p>
                        <img src={Pharmacits} alt="" /></li>
                    <li>
                       
                        <p>مخزن الادوية</p>
                        <img src={drugStore} alt="" /></li>
                    <li>
                        
                        <p>تقارير</p>
                        <img src={reports} alt="" /></li>
                    <li>
                       
                        <p>السجلات</p>
                        <img src={Records} alt="" /></li>
                </ul>
            </div>
        </div>
    )

  ...
  return (
    <>
      <div className="col-span-3 grid grid-cols-2 gap-4 mt-6">
        <div className="bg-white h-[400px] rounded-lg p-4">
          <h4 className="text-3xl text-center mb-4">إحصائيات المرضى</h4>
          <PatientLineChart />
        </div>
        <div className="bg-white h-[400px] rounded-lg grid place-items-center p-4">
          <h4 className="text-3xl text-center mb-4">إحصائيات الدواء</h4>
          <MedicinePieChart />
        </div>
      </div>
      <div className="h-[400px] bg-white col-span-3 p-4">
